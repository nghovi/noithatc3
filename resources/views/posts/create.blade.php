    ...
    <div class="col-md-9">
        <form role="form" action="{{route('posts.store')}}" method="POST"
            ...
            <div class="form-group mb-3">
                ...
                <div class="row">
                    <div class="col-md-6"><input type="file" name="image" class="form-control" onchange="readURL(this);" required/></div>
                    <div class="col-md-6"><img id="blah"/></div>
                </div>
            </div>
        ...
        <a class="" href="{{route('posts.index')}}">View List</a>
    </div>
</div>
